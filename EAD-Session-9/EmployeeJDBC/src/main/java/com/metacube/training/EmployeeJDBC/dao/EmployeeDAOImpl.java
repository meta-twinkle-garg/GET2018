...
public class EmployeeDAOImpl implements EmployeeDAO {
		...
		//private final String SQL_CHECK_LOGIN="SELECT * FROM EMPLOYEE WHERE emp_code=? AND password=?";
		...
		public Employee checkLogin(String username, String password) {
			return jdbcTemplate.query(SQL_CHECK_LOGIN, username, password, new EmployeeMapper());
		}*/
}
