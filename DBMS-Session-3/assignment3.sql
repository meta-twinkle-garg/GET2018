...
insert into orders values(NULL,'2018-06-08', 700,1,3),
(NULL, '2018-06-04',400,2,2);

#Assignment 1
#Contraints applied while creating tables..!!
...
ALTER TABLE product add column STATUS VARCHAR(10)  DEFAULT 'Active'CHECK (STATUS IN('Active','Inactive'));

#Mark the products as Inactive which are not ordered in last 90 days
UPDATE product set product.status='Inactive' where product.id NOT IN(
SELECT * from(
